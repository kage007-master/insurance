...
export const AWAITING_VALIDATOR = "Awaiting Validator";
export const APPROVED_BY_CUSTOMER = "Approved by Customer";
export const APPROVED_BY_VALIDATOR = "Approved by Validator";
